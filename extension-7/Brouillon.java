...
public class Sudoku {
    ...
    public static void suppValPoss2(int [][] gOrdi, int[] TabVal, int i1, int[] TabJ, boolean[][][] valPossibles, int [][]nbValPoss){
